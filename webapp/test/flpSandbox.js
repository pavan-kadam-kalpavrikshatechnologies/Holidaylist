		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapktholidaylistholidaylist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktholidaylistholidaylist-display": {
								"semanticObject": "sapktholidaylistholidaylist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.holidaylist.holidaylist",
									"url": sap.ui.require.toUrl("sap/kt/holidaylist/holidaylist")
								}
							}
						}
					}
